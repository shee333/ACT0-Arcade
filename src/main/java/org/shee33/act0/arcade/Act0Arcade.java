...
import org.shee33.act0.arcade.bot.mc.BotTabListMarker;
...
public final class Act0Arcade {
    ...
    MinecraftForge.EVENT_BUS.register(BotManager.INSTANCE);
    MinecraftForge.EVENT_BUS.register(BotTabListMarker.INSTANCE);
